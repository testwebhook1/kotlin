...
import org.jetbrains.kotlin.analysis.project.structure.NotUnderContentRootProjectModule
import org.jetbrains.kotlin.analysis.project.structure.BinaryProjectModule
import org.jetbrains.kotlin.analysis.project.structure.getProjectModule
...
class IDEKotlinAsJavaFirSupport(private val project: Project) : KotlinAsJavaSupport() {
    ...
    override fun findClassOrObjectDeclarations(fqName: FqName, searchScope: GlobalSearchScope): Collection<KtClassOrObject> =
        fqName.toClassIdSequence().flatMap {
            ...
            when (it.getProjectModule(project)) {
                is BinaryProjectModule -> it.containingKtFile.isCompiled
                is NotUnderContentRootProjectModule -> false
                else -> true
            }
        }.toSet()
