...
import org.jetbrains.kotlin.analysis.project.structure.ProjectModuleScopeProvider
import org.jetbrains.kotlin.analysis.project.structure.ProjectModuleScopeProviderImpl
...
fun MockProject.registerTestServices(
    ...
    registerService(ProjectModuleScopeProvider::class.java, ProjectModuleScopeProviderImpl())
