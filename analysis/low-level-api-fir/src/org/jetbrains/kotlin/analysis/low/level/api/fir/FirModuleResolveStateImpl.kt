...
internal class FirModuleResolveStateImpl(
    ...
    override val module: ProjectModule,
    ...
    override fun getSessionFor(module: ProjectModule): FirSession =
    ...
    private fun findSourceFirDeclarationByExpression(ktDeclaration: KtExpression): FirDeclaration {
        val module = ktDeclaration.getProjectModule(project)
        require(module is SourceSetProjectModule) {
