 ...
 *
 * [ProjectModule] is a Source Set (or considering a new project model naming a Fragment).
 * Some examples of a module: main source set, test source set, library, JDK.
 *
 */
public sealed interface ProjectModule {
    /**
     * A list of Regular (non-MPP) dependencies current module depends on.
     ...
     */
    public val regularDependencies: List<ProjectModule>

    /**
     * Only for Kotlin MPP project.
     * A list of Refinement dependencies.
     * Refinement dependencies express that the current module can provide actual declarations for expect declarations from dependent module,
     * as well as see internal symbols of dependent module.
     *
     * The dependencies list is non-transitive and should not include current module.
     */
    public val refinementDependencies: List<ProjectModule>
     ...
     * The dependencies list is non-transitive and should not include current module.
     */
    public val friendDependencies: List<ProjectModule>
...
public sealed interface ProjectModuleWithProject : ProjectModule {
 ...
 */
public interface SourceSetProjectModule : ProjectModule, ProjectModuleWithProject {
 ...
 */
public sealed interface BinaryProjectModule : ProjectModule, ProjectModuleWithProject {
    /**
 ...
 */
public interface LibraryProjectModule : BinaryProjectModule {
     ...
     */
    public val librarySources: LibrarySourceProjectModule?
 ...
 */
public interface SdkProjectModule : BinaryProjectModule {
...
/**
 * A sources for some [LibraryProjectModule]
 */
public interface LibrarySourceProjectModule : ProjectModuleWithProject {
    public val libraryName: String
     ...
     */
    public val binaryLibrary: LibraryProjectModule
 ...
 */
public interface NotUnderContentRootProjectModule : ProjectModule {
    override val project: Project?
        get() = null
}
