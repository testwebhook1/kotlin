...
public abstract class KotlinModificationTrackerFactory {
    ...
    public abstract fun createModuleWithoutDependenciesOutOfBlockModificationTracker(module: SourceSetProjectModule): ModificationTracker
...
public fun SourceSetProjectModule.createModuleWithoutDependenciesOutOfBlockModificationTracker(project: Project): ModificationTracker =
