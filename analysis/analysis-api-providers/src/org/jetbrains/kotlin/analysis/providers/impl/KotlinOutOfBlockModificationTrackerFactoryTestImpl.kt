...
public class KotlinStaticModificationTrackerFactory : KotlinModificationTrackerFactory() {
    ...
    private val forModule = mutableMapOf<SourceSetProjectModule, SimpleModificationTracker>()
    ...
    override fun createModuleWithoutDependenciesOutOfBlockModificationTracker(module: SourceSetProjectModule): ModificationTracker {
