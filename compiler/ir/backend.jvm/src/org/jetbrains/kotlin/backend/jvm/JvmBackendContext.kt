...
class JvmBackendContext(
    ...
    val fakeContinuation: IrExpression = IrErrorExpressionImpl(
        UNDEFINED_OFFSET,
        UNDEFINED_OFFSET,
        ir.symbols.continuationClass.createType(true, listOf(makeTypeProjection(irBuiltIns.anyNType, Variance.INVARIANT))),
        "FAKE_CONTINUATION"
    )
