...
internal fun parseOutputData(baseDir: File, registeredDirectives: RegisteredDirectives, location: Location): String? =
    parseFileBasedDirective(baseDir, OUTPUT_DATA_FILE, registeredDirectives, location)

internal fun parseInputData(baseDir: File, registeredDirectives: RegisteredDirectives, location: Location): String? =
